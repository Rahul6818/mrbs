...
if (!$ajax)
{
  ...
  //         <label for="search_str"><?php echo get_vocab("Booking Search") ?>:</label>
  ...
  //         ?>
         <!-- </div> 
  //       <div id="div_search_to"> -->
           <?php
  //         //echo "<label>" . get_vocab("to") . ":</label>\n";
  //         //genDateSelector ("to_", $day, $month, $year);
...
$sql_pred = "( " . sql_syntax_caseless_contains("E.create_by", $search_str)
  ...
  . " OR " . sql_syntax_caseless_contains("E.description", $search_str)
  . " OR " . sql_syntax_caseless_contains("R.room_name", $search_str)
  . " OR " . sql_syntax_caseless_contains("E.room_id", $search_str);
...
if (!$ajax_capable || $ajax)
{
  ...
  $sql = "SELECT E.id AS entry_id, E.create_by, E.name, E.description, E.start_time,
                 R.area_id, A.enable_periods, E.room_id
            FROM $tbl_entry E, $tbl_room R, $tbl_area A
           WHERE $sql_pred
