  ...
  foreach ($report_search_field_order as $key)
  {
    switch ($key)
    {
      case 'report_start':
        ...
        echo "<label>" . get_vocab("Search Start Date") . ":</label>\n";
      ...
      case 'report_end':  
        ...
        echo "<label>" . get_vocab("Search End Date") . ":</label>\n";
...
function generate_submit_buttons()
{
  ...
  echo "<input class=\"submit\" type=\"submit\" value=\"" . get_vocab("Search") . "\">\n";
  echo "</div>\n";
}
...
if ($output_form)
{
  ...
  echo "<fieldset>\n";
  echo "<legend>" . get_vocab("Search Bookings") . "</legend>\n";
